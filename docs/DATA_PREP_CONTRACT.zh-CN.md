...
- 后续每个 DRC candidate 的 asset metadata 必须至少能追溯 `source_pdl`、codec、point-cloud mode、`cl`、`qp`、source binary PLY、encoder executable 或 profile provenance；`qc` 当前不作为已生效参数记录。
