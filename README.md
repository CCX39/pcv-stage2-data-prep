...
7. `docs/STAGE2_COMPOSITE_VARIANT_THEORY_HANDOFF.zh-CN.md`
8. `docs/PDL_SAMPLING_AUDIT.zh-CN.md`
9. `docs/DATA_PREP_CONTRACT.zh-CN.md`
10. `docs/DECISION_LOG.zh-CN.md`
...
5. 阶段 2A 已确认后续 DRC delivery candidate 应是 source_pdl 与 Draco profile 组成的 composite representation variant；当前 PLY source assets 不是最终完整 delivery candidate space。
